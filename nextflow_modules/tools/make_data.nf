...
include { toArgs1 } from "./toArgs1.nf"
moduleParams= new nextflow.script.ScriptBinding$ParamsMap(params.make_data) // "navigate"/"select" the right section in the Yaml
...
process make_data {
        ...
        output: // for understanding path: https://www.nextflow.io/docs/latest/process.html?#output-path
            ...
            path "pixel_size.npy", emit: pixel_size
            path "probe_generated.npy", emit: probe_generated
